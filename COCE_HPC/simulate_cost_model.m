...
%Get simdata out, which is plottable and analyzable
    ...
    %of something
    [uc,epsilon,init,missc,mainc,matchc,noisec,respc,lurec,errorc,fac,alpha,delta] = setParamValues(params,modeltosim);
...
%         nerrors = onesubj.nerrors; nFAs = onesubj.nFAs;
%     end
